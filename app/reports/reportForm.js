...
export default function ReportForm() {
    ...
    return (
        ...
        <form onSubmit={handleSubmit} className="p-10 max-w-xl mx-auto shadow-md sm:border-0 md:border md:border-gray-900 md:dark:border-gray-100 bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 md:mr-5 mb-5 md:mb-0 rounded-md">
            <div className="mb-10">
